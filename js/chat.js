...
setTimeout(() => {
  ...
  setTimeout(() => {
    ty.style.display = 'none';
    const msg = 'Hola! Soy Alma, tu guia de Mendoza 🍷 Contame que tipo de viaje tenes en mente — cuantos dias, con quien vas y que te interesa — y te armo el itinerario perfecto.';
    cAdd('cmsg-ai', msg);
